 ...
 */
class IterationNominationRequestDialogController extends ControllerBase {
   ...
   */
  public function nominationDialog() {
    $response = new AjaxResponse();

    // Get the modal form using the form builder.
    $form = $this->formBuilder->getForm('Drupal\social_moodle_enrollment\Form\IterationNominationRequestModalForm');

    $response->addCommand(new OpenModalDialogCommand($this->t('Request for nomination'), $form, static::getDataDialogOptions()));
   ...
   */
  public function nominationAccess(NodeInterface $node) {

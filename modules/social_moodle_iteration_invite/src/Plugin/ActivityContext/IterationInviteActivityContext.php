...
namespace Drupal\social_moodle_iteration_invite\Plugin\ActivityContext;
  ...
  public function getRecipients(array $data, $last_uid, $limit) {
    ...
    if (isset($data['related_object']) && !empty($data['related_object'])) {
      if ($data['related_object'][0]['target_type'] === 'iteration_enrollment') {
        ...
        /** @var \Drupal\social_moodle_enrollment\IterationEnrollmentInterface $iteration_enrollment */

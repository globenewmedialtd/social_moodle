 ...
 */
class EnrollRequestApplicationModalForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'request_enrollment_application_modal_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $options = NULL) {
    ...
    $form['#prefix'] = '<div id="request_enrollment_application">';
    $form['#suffix'] = '</div>';

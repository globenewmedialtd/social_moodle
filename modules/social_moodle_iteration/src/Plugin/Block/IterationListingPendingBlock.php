...
/**
 * Provides a 'IterationListingPendingBlock' block.
 *
 * @Block(
 *  id = "iteration_listing_pending_block",
 *  admin_label = @Translation("Iteration Listing Pending block"),
 * )
 */
class IterationListingPendingBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    if ($group instanceof GroupInterface) {
      ...
      if ($pending) {
        $nodes = \Drupal::entityTypeManager()->getStorage('node')->loadMultiple($pending);

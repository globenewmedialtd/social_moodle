...
/**
 * @file
 * Hooks provided by the Social Moodle Iteration Managers module.
 */
 ...
 *
 * @ingroup social_moodle_iteration_managers_api
 */
function hook_social_moodle_iteration_managers_action_ACTION_ID_finish($success) {
  if ($success) {
    return [

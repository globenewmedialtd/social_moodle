...
/**
 * Delete iteration enrollment entity action.
 *
 * @Action(
 *   id = "social_moodle_iteration_managers_delete_iteration_enrollment_action",
 *   label = @Translation("Delete selected iteration enrollment entities"),
 *   type = "iteration_enrollment",
 *   confirm = TRUE,
 *   confirm_form_route_name = "social_moodle_iteration_managers.vbo.confirm",
 * )
 */
class IterationEnrollmentEntityDeleteAction extends ViewsBulkOperationsActionBase {

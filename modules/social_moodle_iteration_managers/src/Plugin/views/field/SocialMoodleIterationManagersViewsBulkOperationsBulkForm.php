...
namespace Drupal\social_moodle_iteration_managers\Plugin\views\field;
...
class SocialMoodleIterationManagersViewsBulkOperationsBulkForm extends ViewsBulkOperationsBulkForm {
  ...
  /**
   * Constructs a new SocialMoodleIterationManagersViewsBulkOperationsBulkForm object.
   *
  ...
  public function viewsForm(array &$form, FormStateInterface $form_state) {
    ...
    $iteration = social_moodle_iteration_get_current_iteration();
    if (!$iteration) {
      return;
    }
    ...
    $form['#attached']['library'][] = 'social_moodle_iteration_managers/views_bulk_operations.frontUi';
